...
export const runTodoLoadStory = () =>
  runStory(todoProgram, [
    Story.flags({}),
    Story.expectCommand(describeTodoCommand(loadTodos())),
    Story.resolve(describeTodoCommand(loadTodos()), todosLoaded([firstTodo])),
...
export const runTodoAddAndSaveStory = () =>
  runStory(todoProgram, [
    Story.flags({}),
    Story.resolve(describeTodoCommand(loadTodos()), todosLoaded([])),
...
export const runTodoToggleDeleteStory = () =>
  runStory(todoProgram, [
    ...
    Story.resolve(
      describeTodoCommand(saveTodos([{ ...firstTodo, completed: true }])),
      todosSaved(),
    ),
...
export const runTodoFailureAndRetryStory = () =>
  runStory(todoProgram, [
    Story.flags({}),
    Story.resolve(describeTodoCommand(loadTodos()), todosLoadFailed('offline')),
    Story.expectModelPartial<TodoModel>({
