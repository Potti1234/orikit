...
21. [Phase 9 view boundary](docs/nativescript/20-phase9-view-boundary.md)
22. [Foldkit portable-kernel plan](docs/nativescript/21-foldkit-portable-kernel-plan.md)
23. [Live Foldkit Command runtime](docs/nativescript/22-live-command-runtime-rewrite.md)
24. [NativeScript adapter study](docs/nativescript/23-nativescript-renderer-adapter-study.md)
25. [Foldkit NativeScript renderer plan](docs/nativescript/24-foldkit-nativescript-renderer-plan.md)
26. [Native renderer verification plan](docs/nativescript/25-native-renderer-verification-plan.md)
